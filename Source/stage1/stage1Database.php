...
<input type="submit" id= "butRedirect" style="height:60px; font-size:21px;" value="Finalize and submit"/><br />or<br />
</form>
...
for($j = 0; $j < $rows; ++$j)
{
	...
	<div id="resultsID">
	<table border="0">
	<tr><td><h3>Industrial Broker of the Year:</h3> $row[4]&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Investment Broker of the Year:</h3> $row[7]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Retail Broker of the Year:</h3> $row[10]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Office Broker of the Year:</h3> $row[13]</td></tr><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
	<tr><td><h3>Architectural Firm of the Year:</h3> $row[16]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Contractor of the Year:</h3> $row[19]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Developer of the Year:</h3> $row[22]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Property Manager of the Year:</h3> $row[25]</td></tr><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
	<tr><td><h3>Real Estate Attorney of the Year:</h3> $row[28]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Commercial Real Estate Broker of the Year:</h3> $row[31]</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><h3>Mid Market Real Estate Broker of the Year:</h3> $row[34]</td></tr>
	</table>
	</div>
	</pre>
