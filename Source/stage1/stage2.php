...
//****
	jQuery(function(){
        if (jQuery('.category1Button').is(':checked')) {
          document.getElementById("next2").disabled = false;
    } if (jQuery('.category2Button').is(':checked')){
           document.getElementById("next3").disabled = false;
    } if(jQuery('.category3Button').is(':checked')){
           document.getElementById("next4").disabled = false;
    } if(jQuery('.category4Button').is(':checked')){
           document.getElementById("next5").disabled = false;
    } if(jQuery('.category5Button').is(':checked')){
           document.getElementById("next6").disabled = false;
    } if(jQuery('.category6Button').is(':checked')){
           document.getElementById("next7").disabled = false;
    } if(jQuery('.category7Button').is(':checked')){
           document.getElementById("next8").disabled = false;
    } if(jQuery('.category8Button').is(':checked')){
           document.getElementById("next9").disabled = false;
    } if(jQuery('.category9Button').is(':checked')){
           document.getElementById("next10").disabled = false;
    } if(jQuery('.category10Button').is(':checked')){
           document.getElementById("next11").disabled = false;
    } if(jQuery('.category11Button').is(':checked')){
...
jQuery('#buttonSave').show();
		...
		jQuery('#categoryTen').hide();
		//jQuery('#buttonSave').prop("disabled",false);
if(jQuery("input.category10Button[type=checkbox]:checked").length){
	jQuery('#buttonSave').show();
}
...
<!--********CALC********-->
 ...
 <!--   <div style="background-color:#cccccc; width: 1100px; height: 50px;"><img src="images/downArrow.gif" /><p style="vertical-align:top; margin-left: 8px; display:inline-block;">Please see the specifications for the voting criteria below&nbsp; &nbsp;</p><img src="images/downArrow.gif" /></div>-->
...
<tr><td>Total:</td><td><input type="text" id="1resul1" value=""/></td><td><input type="text" id="1resul2" value=""/></td><td><input type="text" id="1resul3" value=""/></td></tr>
...
<tr><th>Criteria</th><th>Finalist 1</th><th>Finalist 2</th><th>Finalist 3</th></tr>
<form>
<tr><td>Total dollar value of lease and sale (considerations) from 11/1/12 to 11/1/13 (50 points):</td><td><input type="text" id="2oper1a" value="" onblur="checkVal50(value, id)"/></td><td><input type="text" id="2oper2a" value="" onblur="checkVal50(value, id)"/></td><td><input type="text" id="2oper3a" value="" onblur="checkVal50(value, id)"/></td></tr>
...
<form>
<tr><td>Vision of the Project and Impact on Community: Judge the project on its overall impact on the community (e.g. how does it impact and foster community growth, vitality, longevity, and stability) (25 points):</td><td><input type="text" id="6oper1a" value="" onblur=""/></td><td><input type="text" id="6oper2a" value="" onblur=""/></td></tr>
<tr><td>Innovative Design: Judge the project on its design characteristics (e.g. creativity, sustainability, construction quality, etc.)  (25 points):</td><td><input type="text" id="6oper1b" value="" onblur=""/></td><td><input type="text" id="6oper2b" value="" onblur=""/></td></tr>
<tr><td>Highest and Best Use for the Site: Judge the project on its use(s). Score it based on your opinion of whether this project is the right use for this site and whether it isa good fit for the location and neighborhood. Though not a determinant, economic feasibility is also a factor in this criteria and the applicant should discuss it. However, there is no expectation of disclosing confidential information.  (25 points):</td><td><input type="text" id="6oper1c" value="" onblur=""/></td><td><input type="text" id="6oper2c" value="" onblur=""/></td></tr>
<tr><td>Reputation: Judge the developer on its repuation based on the submittal and testimonial(s) (20 points):</td><td><input type="text" id="6oper1d" value="" onblur=""/></td><td><input type="text" id="6oper2d" value="" onblur=""/></td></tr>
<tr><td>Quality of application (5 points):</td><td><input type="text" id="6oper1e" value="" onblur=""/></td><td><input type="text" id="6oper2e" value="" onblur=""/></td></tr>
...
<tr><th>Criteria</th><th>Finalist 1</th><th>Finalist 2</th></tr>
<form>
<tr><td>Complexity of Case Work: The condidate should demonstrate his/her ability to handle complex real estate cases and transactions (40 points):</td><td><input type="text" id="8oper1a" value="" onblur="checkVal40(value, id)"/></td><td><input type="text" id="8oper2a" value=""/></td></tr>
<tr><td>Gravity of Case Work: Judge the candidate on the impact of the cases and transactions. (i.e. how major are the cases based on their impact on the industry and on the client) (30 points):</td><td><input type="text" id="8oper1b" value="" onblur="checkVal30(value, id)"/></td><td><input type="text" id="8oper2b" value="" onblur="checkVal30(value, id)"/></td></tr>
<tr><td>Leadership and Civility: Based on the candidates' testimonials and application, judge his/her reputation of civility and professionalism and leadership experience within the firm (25 points):</td><td><input type="text" id="8oper1c" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="8oper2c" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Quality of application(5 points):</td><td><input type="text" id="8oper1d" value="" onblur="checkVal5(value, id)"/></td><td><input type="text" id="8oper2d" value="" onblur="checkVal5(value, id)"/></td></tr>
<tr><td>Total:</td><td><input type="text" id="8resul1" value=""/></td><td><input type="text" id="8resul2" value=""/></td></tr>
...
<tr><th>Criteria</th><th>Finalist 1</th><th>Finalist 2</th><th>Finalist 3</th></tr>
<form>
<tr><td>Largest Loan: You will be judged on the overall size of your largest loan (25 points):</td><td><input type="text" id="9oper1a" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper2a" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper3a" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Number of Loans: How many loans did you close and what was the total amount (25 points):</td><td><input type="text" id="9oper1b" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper2b" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper3b" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Written Testimonials: Between one and three testimonials from clients, peers, co-workers, or similar professionals describing how the loan helped them and the Utah economy and/or attesting to why you should receive the award (25 points):</td><td><input type="text" id="9oper1c" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper2c" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="9oper3c" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Community Service: What have you done in the past three years in giving back to the community (20 points):</td><td><input type="text" id="9oper1d" value="" onblur="checkVal20(value, id)"/></td><td><input type="text" id="9oper2d" value="" onblur="checkVal20(value, id)"/></td><td><input type="text" id="9oper3d" value="" onblur="checkVal20(value, id)"/></td></tr>
<tr><td>Quality of the Application: The candidate will be judges on the pictures, project details and overall look and feel of the application (5 points):</td><td><input type="text" id="9oper1e" value="" onblur="checkVal5(value, id)"/></td><td><input type="text" id="9oper2e" value="" onblur="checkVal5(value, id)"/></td><td><input type="text" id="9oper3e" value="" onblur="checkVal5(value, id)"/></td></tr>
...
<tr><th>Criteria</th><th>Finalist 1</th><th>Finalist 2</th><th>Finalist 3</th></tr>
<form>
<tr><td>Largest Loan: You will be judged on the overall size of your largest loan (25 points):</td><td><input type="text" id="10oper1a" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper2a" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper3a" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Number of Loans: How many loans did you close and what was the total amount (25 points):</td><td><input type="text" id="10oper1b" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper2b" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper3b" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Written Testimonials: Between one and three testimonials from clients, peers, co-workers, or similar professionals describing how the loan helped them and the Utah economy and/or attesting to why you should receive the award (25 points):</td><td><input type="text" id="10oper1c" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper2c" value="" onblur="checkVal25(value, id)"/></td><td><input type="text" id="10oper3c" value="" onblur="checkVal25(value, id)"/></td></tr>
<tr><td>Community Service: What have you done in the past three years in giving back to the community (20 points):</td><td><input type="text" id="10oper1d" value="" onblur="checkVal20(value, id)"/></td><td><input type="text" id="10oper2d" value="" onblur="checkVal20(value, id)"/></td><td><input type="text" id="10oper3d" value="" onblur="checkVal20(value, id)"/></td></tr>
<tr><td>Quality of the Application: The candidate will be judges on the pictures, project details and overall look and feel of the application (5 points):</td><td><input type="text" id="10oper1e" value="" onblur="checkVal5(value, id)"/></td><td><input type="text" id="10oper2e" value="" onblur="checkVal5(value, id)"/></td><td><input type="text" id="10oper3e" value="" onblur="checkVal5(value, id)"/></td></tr>
